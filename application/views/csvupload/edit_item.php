...
<table border="0" width="100%" cellpadding="0" cellspacing="0" id="content-table">
  ...
  <tr>
    ...
    <td><div id="content-table-inner">
        ...
        <form method="post" action="<?php echo $url;?>csvupload/update">
        <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
        	<input type="hidden" name="id" value="<?php echo $result[0]->ordernumber; ?>" />
              

              <?php $this->load->view('csvupload/edit_item_tr', Array(
